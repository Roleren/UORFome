...
df2 <- data.frame(LSU = c(p(mergedF, "64_cell_LSU_V7.bam"), p(mergedF, "64_cell_LSU_V8.bam"),
                          ...
                          p(mergedF, "sphere3_V7_merged_LSU.bam")),
                  stage = c(rep("64", 2), rep("shield", 4), rep("sphere", 3)),
                  type = c(rep("WT", 2), rep("WT", 3), "WT_ALL", rep("WT", 3)), stringsAsFactors = FALSE)
...
reads5L <- ORFik:::convertToOneBasedRanges(readsL, method = "5prime", addSizeColumn = TRUE)
reads3L <- ORFik:::convertToOneBasedRanges(readsL, method = "3prime", addSizeColumn = TRUE)
...
# SSU
scoring <- "zscore"
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsSSU, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "SSU_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsSSU, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "SSU_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSU, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU15_shield_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSU, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU15_shield_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV6, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU6_shield_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV6, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU6_shield_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV5, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU5_shield_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV5, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU5_shield_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_64_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_64_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV8, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU8_64_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV8, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU8_64_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S1, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere1_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S1, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere1_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S2, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere2_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S2, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere2_TSS_heatmap_3prime.png"), scores = scoring)

tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S3, addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere3_TSS_heatmap_5prime.png"), scores = scoring)
tcpHeatMap_single(leadersShield, extendLeaders(leadersShield, extension = 50), ORFik:::convertToOneBasedRanges(readsLSUV7S3, method = "3prime", addSizeColumn = TRUE), upstream = 30, downstream = 99, outdir = paste0(heatMapsFolder, "LSU7_sphere3_TSS_heatmap_3prime.png"), scores = scoring)
